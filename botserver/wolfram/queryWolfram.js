...
const wolfram_query_intent = (wit_intent, location, numberOfLocations, callback) => {
    switch (wit_intent) {
        ...
        case witEntities.intents.get_unemploy:
            wolfram_query_random(location + " unemployment rate", numberOfLocations, callback);
            break;
        case witEntities.intents.get_population:
            wolfram_query_random(location + " population", numberOfLocations, callback);
            break;
        default:
            break;
    }
